  ...
  <TooltipTrigger asChild>
    <div
                  ...
                  >
                    ...
                    <span className="absolute left-5 top-1/2 -translate-y-1/2 whitespace-nowrap rounded-full bg-slate-900 px-2 py-0.5 text-xs font-medium text-white opacity-90">
                      #{index + 1}
                    </span>
                  </div>
  </TooltipTrigger>
  <TooltipContent>{`${row.title} · 偏差 ${row.deviation_days} 天 · 偏差率 ${row.deviation_rate}%`}</TooltipContent>
</Tooltip>
                )
              })}
            </div>
