...
import { isLaggingTask } from '@/lib/taskBusinessStatus'
    ...
    <SortableTaskRowWrapper key={task.id} id={task.id}>
        ...
        className={`group flex items-center px-4 transition-colors hover:bg-accent/30 ${getTreeRowHeightClass(rowKind)} ${
          isInDependencyChain
            ...
            : isOverdue
              ...
              : isLaggingTask(task) === 'lagging_severe'
              ? 'border-l-4 border-l-orange-500 bg-orange-50/40'
              : isLaggingTask(task) === 'lagging_moderate'
      ...
      >
        ...
        <TaskRowDetailCells
          ...
          inlineProgressTaskId={props.inlineProgressTaskId}
          inlineProgressValue={props.inlineProgressValue}
          onInlineProgressValueChange={props.onInlineProgressValueChange}
          onInlineProgressSave={props.onInlineProgressSave}
          onCancelInlineProgressEdit={props.onCancelInlineProgressEdit}
          onStartInlineProgressEdit={props.onStartInlineProgressEdit}
          getTaskFloat={props.getTaskFloat}
          isOnCriticalPath={props.isOnCriticalPath}
