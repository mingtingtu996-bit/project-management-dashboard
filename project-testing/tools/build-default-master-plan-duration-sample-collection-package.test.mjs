...
test('builds a no-write duration sample collection package from a gap plan', async () => {
  ...
  try {
    ...
    assert.match(report.nextCommands.rebuildFullSourceManifestFromExistingExports, /--runtime-publications .*duration-learning-runtime-publications-export\.json/)
    assert.match(report.nextCommands.rebuildFullSourceManifestFromExistingExports, /--runtime-consumptions .*duration-learning-runtime-consumptions-export\.json/)
    assert.doesNotMatch(report.nextCommands.rebuildFullSourceManifestFromExistingExports, /wbs-template-runtime-publications-export\.json/)
