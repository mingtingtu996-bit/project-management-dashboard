...
test('accepts aliased production outcome fields when the evidence is complete', () => {
  const evidence = normalizeRealProductionOutcomeEvidence({
    ...
    runtime_publication_evidence_ref: `duration_learning_runtime_publications_export:project-testing/reports/default-master-plan-production-readiness/runtime-publications.json#sha256=${'1'.repeat(64)}`,
    runtime_consumption_evidence_ref: `duration_learning_runtime_consumptions_export:project-testing/reports/default-master-plan-production-readiness/runtime-consumptions.json#sha256=${'6'.repeat(64)}`,
  ...
  assert.deepEqual(evidence, {
    ...
    runtimePublicationEvidenceRef: `duration_learning_runtime_publications_export:project-testing/reports/default-master-plan-production-readiness/runtime-publications.json#sha256=${'1'.repeat(64)}`,
    runtimeConsumptionEvidenceRef: `duration_learning_runtime_consumptions_export:project-testing/reports/default-master-plan-production-readiness/runtime-consumptions.json#sha256=${'6'.repeat(64)}`,
