...
function buildRealProductionOutcomeTemplate({ template, baselineId, projectId, publicationKey, targetEnvironment }) {
  ...
  return {
    ...
    example: {
      ...
      runtimePublicationEvidenceRef: 'duration_learning_runtime_publications_export:<production-runtime-publications-export.json>#sha256=<64hex>',
      runtimeConsumptionEvidenceRef: 'duration_learning_runtime_consumptions_export:<production-runtime-consumptions-export.json>#sha256=<64hex>',
