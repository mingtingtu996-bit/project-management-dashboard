...
export async function buildDefaultMasterPlanDurationSampleCollectionPackage({
  ...
  const report = {
    ...
    nextCommands: {
      ...
      rebuildFullSourceManifestFromExistingExports: `npm run evidence:default-master-plan:export-sources -- --phase all --baseline-id ${baselineId || '<baseline-id>'} --project-id ${projectId || '<project-id>'} --publication-key <publication-key> --environment ${environmentText} --exported-by ${exportedByText} --review-export project-testing/reports/default-master-plan-production-readiness/source-exports/candidate-default-master-plan-review-export.json --duration-samples project-testing/reports/default-master-plan-production-readiness/source-exports/duration-experience-samples-export.json --raw-completed-tasks project-testing/reports/default-master-plan-production-readiness/source-exports/raw-completed-tasks.json --task-dependencies project-testing/reports/default-master-plan-production-readiness/source-exports/task-dependencies-export.json --runtime-publications project-testing/reports/default-master-plan-production-readiness/source-exports/duration-learning-runtime-publications-export.json --runtime-consumptions project-testing/reports/default-master-plan-production-readiness/source-exports/duration-learning-runtime-consumptions-export.json --writer-result <dependency-writer-result.json> --critical-path-readback <critical-path-readback.json> --api-read-smoke <api-read-smoke.json> --ui-consumption-smoke <ui-consumption-smoke.json> --rollback-verification <rollback-verification.json>`,
