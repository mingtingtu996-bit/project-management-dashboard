...
describe('wbsTemplateGoldenBenchmarkGateService', () => {
  ...
  it('builds a WBS reference-days publication readiness package from a passing benchmark and approved candidates', () => {
    ...
    const readiness = buildWbsReferenceDaysPublicationReadiness({
      ...
      runtimePublicationKey: 'duration_learning_runtime:wbs_reference_days:wbs-reference-days-v2',
      runtimeConsumerObservationRef: 'runtime_consumer:consumer-reference-days-1',
      runtimeConsumerPublicationKey: 'duration_learning_runtime:wbs_reference_days:wbs-reference-days-v2',
      rollbackTarget: 'duration_learning_runtime:wbs_reference_days:wbs-reference-days-v1',
      enabledLearningScopes: ['system', 'industry_baseline', 'company', 'project'],
      releaseExitApproved: true,
      impactMonitoringReady: true,
      accuracyMetricsAvailable: true,
  ...
  it('builds WBS reference-days publication readiness from production source rows', () => {
      ...
      sourceRows: [
        {
          ...
          row: {
            publication_key: 'duration_learning_runtime:wbs_reference_days:wbs-reference-days-v2',
            asset_key: 'wbs_reference_days',
            artifact_key: 'wbs-reference-days-v2',
            scope_level: 'project',
            publication_stage: 'stable',
            source_evidence_refs: ['candidate:wbs-reference-days-v2'],
        ...
        },
        {
          ...
          row: {
            ...
            observation_context: { artifactKey: 'wbs-reference-days-v2' },
            source_evidence_refs: [
              'duration_learning_runtime_publications:duration_learning_runtime:wbs_reference_days:wbs-reference-days-v2',
            ],
        ...
        },
        {
          ...
          row: {
            ...
            prediction_context: {
              assetKey: 'wbs_reference_days',
              publicationKey: 'duration_learning_runtime:wbs_reference_days:wbs-reference-days-v2',
            },
            actual_context: {
              assetKey: 'wbs_reference_days',
    ...
    expect(readiness.referenceDaysLineage).toEqual(expect.objectContaining({
      referenceDaysVersionId: 'wbs-reference-days-v2',
      runtimePublicationKey: 'duration_learning_runtime:wbs_reference_days:wbs-reference-days-v2',
      rollbackTarget: 'rollback:duration_learning_runtime:wbs_reference_days:wbs-reference-days-v2:rollback_verified',
      approvedCandidateEventIds: ['reference-candidate-1'],
      benchmarkScenarioCount: 13,
    }))
    expect(readiness.productionLineage.evidenceRefs).toEqual(expect.objectContaining({
      ...
      publicationExecutionRef: 'duration_learning_runtime_publications:duration_learning_runtime:wbs_reference_days:wbs-reference-days-v2',
      runtimeConsumerObservationRef: 'runtime_consumer:consumer-reference-days-1',
      impactMonitoringEvidenceRef: 'impact_monitoring:duration_learning_runtime:wbs_reference_days:wbs-reference-days-v2:monitoring_passed',
      rollbackDrillEvidenceRef: 'rollback:duration_learning_runtime:wbs_reference_days:wbs-reference-days-v2:rollback_verified',
    ...
    const readiness = buildWbsReferenceDaysPublicationReadinessFromProductionRows({
      ...
      sourceRows: [
        ...
        },
        {
          sourceTable: 'duration_learning_runtime_publications',
          row: {
            publication_key: 'duration_learning_runtime:wbs_reference_days:wbs-reference-days-v1',
            asset_key: 'wbs_reference_days',
            artifact_key: 'wbs-reference-days-v1',
            scope_level: 'project',
            publication_stage: 'stable',
            source_evidence_refs: ['candidate:wbs-reference-days-v1'],
            automation_decision: { stage: 'stable', autoPromotionAllowed: true },
        ...
        },
        {
          ...
          row: {
            ...
            publication_key: 'duration_learning_runtime:wbs_reference_days:wbs-reference-days-v1',
            observation_status: 'observed',
            observation_context: { artifactKey: 'wbs-reference-days-v1' },
            source_evidence_refs: [
              'duration_learning_runtime_publications:duration_learning_runtime:wbs_reference_days:wbs-reference-days-v1',
            ],
            writes_runtime_directly: false,
            writes_fact_directly: false,
          },
