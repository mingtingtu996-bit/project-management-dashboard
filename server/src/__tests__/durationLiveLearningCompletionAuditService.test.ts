...
describe('durationLiveLearningCompletionAuditService', () => {
  ...
  it('accepts liveLearningEvidence emitted by every v1.4.22.5 bridge as completion audit overrides', () => {
    ...
    const confidence = buildForecastScopedRuntimeLiveLearningEvidence({
      ...
      runtimeConsumerObservationRef: 'runtime_consumer:forecast-confidence:observed',
      runtimeConsumerPublicationKey: 'forecast_confidence_weight_runtime:weight-v2',
    ...
    const standard = buildStandardWorkDurationSeedPublicationReadiness({
        ...
        replay: {
          ...
          calibrationQueues: {
            p50ReviewCandidates: [{
              ...
              observationEndedAt: '2026-06-14T00:00:00.000Z',
              observationWindowDays: 13,
              automationQualityEvidence: {
                qualityModel: 'numeric_holdout',
                holdoutSampleCount: 1,
                maeBefore: 3,
                maeAfter: 0,
                conflictRate: 0,
      ...
      runtimeConsumerObservationRef: 'runtime_consumer:standard-seed:observed',
      runtimeConsumerPublicationKey: 'algorithm_seed_versions:standard-v2',
    ...
    const special = buildSpecialWorkDurationSeedPublicationReadiness({
      ...
      runtimeConsumerObservationRef: 'runtime_consumer:special-seed:observed',
    ...
    const wbs = buildWbsReferenceDaysPublicationReadiness({
      ...
      runtimeConsumerObservationRef: 'runtime_consumer:wbs-reference-days:observed',
    ...
    const dependency = buildConstructionDependencyRulePublicationReadiness({
      ...
      runtimeConsumerObservationRef: 'runtime_consumer:dependency-rule:observed',
    ...
    const critical = buildCriticalPathRulePublicationReadiness({
      ...
      runtimeConsumerObservationRef: 'runtime_consumer:critical-path-rule:observed',
