...
const TUNABLE_PARAMETER_SOURCE_INVENTORY: readonly AlgorithmAssetTunableParameterSourceInventoryEntry[] = [
  ...
  },
  {
    ...
    sourcePath: 'server/src/services/durationContextService.ts',
    sourceSymbols: ['SITE_PRESSURE_MULTIPLIER_PARAMETER_KEY', 'SITE_PRESSURE_MULTIPLIER_CANARY_BOUNDARY'],
  ...
  },
  {
    ...
    classification: 'frozen',
    owner: 'durationContextService',
    reason: 'Application multiplier and confidence bounds remain fixed defense-in-depth controls.',
    sourcePath: 'server/src/services/durationContextService.ts',
    sourceSymbols: [
  ...
  },
  {
    ...
    reason: 'Resolver timeout and schedule-acceleration fallbacks are fixed cold-start behavior.',
    sourcePath: 'server/src/services/algorithmSeedResolver.ts',
    sourceSymbols: [
      'DEFAULT_ALGORITHM_SEED_RESOLVER_READ_TIMEOUT_MS',
      'SCHEDULE_ACCELERATION_DEFAULT_PROFILE_CODE_FROM_RESOLVER',
      'SCHEDULE_ACCELERATION_DEFAULT_RESOURCE_CRASH_CAP_FROM_RESOLVER',
    ],
    registryParameterKeys: [],
  },
  {
  ...
  {
    inventoryKey: 'duration.context.parameter_learning_tier_default',
    classification: 'frozen',
    owner: 'durationContextPolicyParameterLearningService',
    reason: 'The default evidence tier is fixed learning-governance policy.',
    sourcePath: 'server/src/services/durationContextPolicyParameterLearningService.ts',
    sourceSymbols: ['DEFAULT_DURATION_CONTEXT_POLICY_PARAMETER_EXPERIENCE_TIER'],
    registryParameterKeys: [],
  },
  {
  ...
  },
  {
    ...
    sourceSymbols: ['WEATHER_MULTIPLIER_PARAMETER_KEY', 'WEATHER_MULTIPLIER_CANARY_BOUNDARY'],
  ...
  {
    inventoryKey: 'duration.metric_timezone_default',
    classification: 'frozen',
    owner: 'durationMetricService',
    reason: 'Duration metric timezone is a fixed semantic default.',
    sourcePath: 'server/src/services/durationMetricService.ts',
    sourceSymbols: ['DEFAULT_DURATION_TIMEZONE'],
    registryParameterKeys: [],
  },
  {
    inventoryKey: 'duration.runtime_consumer_audit_root',
    classification: 'frozen',
    owner: 'durationRuntimeConsumerBusinessPathIntegrationAuditService',
    reason: 'The audit repository root is fixed tooling configuration.',
    sourcePath: 'server/src/services/durationRuntimeConsumerBusinessPathIntegrationAuditService.ts',
    sourceSymbols: ['DEFAULT_REPO_ROOT'],
    registryParameterKeys: [],
  },
  {
