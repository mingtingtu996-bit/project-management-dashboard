...
const NON_SEED_RULE_ASSETS: AlgorithmRuleAsset[] = [
  ...
  {
    key: 'planningReplayCalibrationService',
    name: 'Planning replay calibration service',
    source: 'server/src/services/planningReplayCalibrationService.ts',
    lifecycleType: 'service_governance',
    governanceSystem: 'planning_replay_calibration_governance',
    ownerService: 'planningReplayCalibrationService',
    role: 'shared replay calibration loop for baseline generation and monthly plan generation, grouped by coarse process before any fine project type, building, climate or workface split; production sweep is orchestrated by planningReplayCalibrationJob and persists replay evidence through algorithmAssetReplayService',
    ...
    consumers: [
      ...
      'duration live-learning governance',
      'asset governance diagnostics',
    ],
    recommendation: 'keep_independent_governance',
    reason: 'The service converts historical baseline/monthly plan replay into coarse-process calibration candidates while preserving baseline, monthly plan, task, actual and seed fact locks.',
    boundaryPolicy: [
      ...
      'calibration_candidates_write_governance_evidence_only',
      'production_sweep_persists_algorithm_asset_replay_evidence_only',
      ...
      'replay_calibration_does_not_grant_runtime_publish_rights',
    ],
  },
  {
  ...
  },
  {
    ...
    name: 'Construction organization scenario selector',
    ...
    role: 'project-generation-fact driven construction organization scenario candidates for WBS assembly and E5 acceleration evaluation',
    consumers: ['wbsTemplateGenerationService', 'scheduleAccelerationService', 'wbsTaskStructureGovernancePipelineService'],
    recommendation: 'evaluate_before_seed_inclusion',
    reason: 'The selector creates governed scenario candidates and virtual network hints from existing wizard/project facts; promotion must happen through rule-asset governance, not direct seed or dependency mutation.',
    learningTarget: 'candidate_weight',
    learningMaturity: 'governed_candidate',
    publishAnchor: 'manual_governance_required',
    automationMaturity: 'auto_review_package',
  ...
  },
  {
    ...
    name: 'Construction organization scenario governance service',
    ...
    role: 'persists construction organization plan options as governed candidate-weight events for replay, review and later publication decisions',
    consumers: [
      'algorithmAssetCandidateEventAdapterService',
      'algorithm asset governance workbench',
      'wbsTaskStructureGovernancePipelineService',
      'scheduleAccelerationService diagnostics',
    ],
    recommendation: 'keep_independent_governance',
    reason: 'Construction organization plan options are useful learning and governance evidence, but must stay candidate-only until replay, conflict cleanup, consumer verification, monitoring and rollback evidence approve a runtime rule.',
    learningTarget: 'candidate_weight',
    learningMaturity: 'governed_candidate',
    publishAnchor: 'manual_governance_required',
    automationMaturity: 'auto_review_package',
    boundaryPolicy: [
      ...
      'plan_options_are_governance_candidates_not_runtime_schedule_truth',
      'runtime_publication_requires_replay_conflict_cleanup_consumer_verification_monitoring_and_rollback',
    ],
  },
]
