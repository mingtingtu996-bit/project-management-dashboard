...
const workflowContractTests = [
  ...
  'src/__tests__/securityAdvisorRetirementStateRlsMigration.test.ts',
  'src/__tests__/securityAdvisorRetirementStateRlsService.test.ts',
  'src/__tests__/advisorRetirementStateRlsWorkflowContract.test.ts',
