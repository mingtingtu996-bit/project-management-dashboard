-- CANONICAL: current clean bootstrap bundle, synchronized through migration 339
...
-- ============================================================
-- Source: 322_duration_learning_legacy_runtime_retirement.sql
-- ============================================================
...
-- ============================================================
-- Source: 323_duration_learning_runtime_evidence_outbox.sql
-- ============================================================
...
-- ============================================================
-- Source: 331_schedule_acceleration_recommendations.sql
-- ============================================================
BEGIN;
...
COMMIT;
-- ============================================================
-- Source: 332_schedule_acceleration_adoption_hardening.sql
-- ============================================================
BEGIN;
...
-- ============================================================
-- Source: 333_staging_schema_drift_reconciliation.sql
-- ============================================================
...
-- ============================================================
-- Source: 337_construction_dependency_replay_runtime_rls.sql
-- ============================================================
...
-- ============================================================
-- Source: 338_risk_issue_atomic_closure_outcome.sql
-- ============================================================
-- Keep risk-to-issue conversion compatible with structured closure outcomes.
...
BEGIN
  ...
  SET
    ...
    closure_result_code = 'transferred',
    closure_result_summary = 'Escalated to linked issue',
    closure_effectiveness = 'transferred',
    closure_evidence_refs = jsonb_build_array('issue:' || v_issue_id::TEXT),
    closure_cause_attribution_id = NULL,
    closed_by = NULL,
    closure_recorded_at = v_timestamp,
    updated_at = v_timestamp
  WHERE id = p_risk_id;
...
BEGIN
  IF function_oid IS NULL THEN
    RAISE EXCEPTION 'migration 338 did not create create_issue_from_risk_atomic';
  END IF;
  ...
  IF POSITION('closure_result_code = ''transferred''' IN function_definition) = 0
     OR POSITION('closure_effectiveness = ''transferred''' IN function_definition) = 0
     OR POSITION('closure_recorded_at = v_timestamp' IN function_definition) = 0 THEN
    RAISE EXCEPTION 'migration 338 function body failed structured closure readback';
  END IF;

  IF NOT COALESCE(function_config, ARRAY[]::TEXT[])
    @> ARRAY['search_path=public, pg_temp']::TEXT[] THEN
    RAISE EXCEPTION 'migration 338 function search_path readback failed';
  END IF;

  RAISE NOTICE 'MIGRATION_338_RISK_ISSUE_ATOMIC_CLOSURE_OUTCOME_READBACK_COMPLETE';
END $$;
...
COMMIT;
-- ============================================================
-- Source: 339_notification_project_reference_retirement.sql
-- ============================================================
